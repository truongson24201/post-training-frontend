...
import { IGraduationPreview, IGradutationView, getGraduations, previewGraduations } from "@/apis/Graduations";
...
export default function GraduationThesisView() {
    ...
    async function fetchGraduations() {
        try {
            ...
            const { data: response } = await getGraduations(Number.parseInt(facultyId),selectedYear);
